...
def test_data_isolation_between_customers():
    """
    Test crítico para el modelo SaaS multi-tenant: dos clientes (empresas)
    distintos que buscan el mismo nicho/ciudad NUNCA deben compartir fila,
    ni poder ver o modificar los negocios del otro.
    """
