...
from app.core.db_engine_guard import log_database_engine  # noqa: E402
...
# Punto #3 del procedimiento: registra en logs qué motor se va a usar,
# cada vez que Alembic arranca (autogenerate, upgrade, downgrade...).
log_database_engine()
...
# Esto es una capa adicional de robustez, NO sustituye al bloqueo explícito
# en la migración multi-tenant, que directamente rechaza correr en SQLite.
